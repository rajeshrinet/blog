...
toc: true
layout: post
description: Phoresis and Stokesian hydrodynamics of colloidal particles
categories: [markdown]
...
The above formalism has been implemented in a numerical library, PyStokes. [PyStokes](https://github.com/rajeshrinet/pystokes) is a numerical library for phoresis and Stokesian hydrodynamics in Python. The resulting methodology has been applied to study various experimental phenomena of recent interest in active matter. In what follows, we present we present a selected list of applications. 
